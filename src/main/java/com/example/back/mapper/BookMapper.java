...
public interface BookMapper {
    ...
    List<Book> listBooks(@Param("offset") Integer offset, @Param("size") Integer size);
    ...
    List<Book> getBooksByType(@Param("book_type") String book_type, @Param("offset") Integer offset, @Param("size") Integer size);

    // 新增方法
    List<Book> getBooksBySellerId(@Param("book_seller_id") String book_seller_id, @Param("offset") Integer offset, @Param("size") Integer size);

    // 新增方法
    List<Book> getBooksByTitle(@Param("title") String title, @Param("offset") Integer offset, @Param("size") Integer size);

    // 新增方法
    List<Book> getBooksByTitleContaining(@Param("title") String title, @Param("offset") Integer offset, @Param("size") Integer size);
    ...
    List<Book> getUnreviewedBooks(@Param("offset") Integer offset, @Param("size") Integer size);

    // 新增方法：获取所有被禁止的书籍（is_banned = 1）
    List<Book> getBannedBooks(@Param("offset") Integer offset, @Param("size") Integer size);
